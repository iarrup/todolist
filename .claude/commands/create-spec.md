---
description: Create a spec file and feature branch for the next todo feature. Refer to PROGRESS.md for the feature details.
argument-hint: "Phase number and Feature number e.g. Phase 1 F1"
allowed-tools: Read, Write, Glob, Bash(git:*)
---

You are a senior developer spinning up a new feature for todolist. Always follow the rules in CLAUDE.md.
...
1. `phase_number` — single digit

2. `feature_number` — Feature number that matches the feature number on PROGRESS.md
   - Example: "F1" or "F2"
...
- `PROGRESS.md` — For phase and feature roadmap
- `ideas-refined.md` — application detailed reqeuirements
